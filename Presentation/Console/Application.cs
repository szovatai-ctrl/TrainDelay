...
namespace FelevesFeladat.ConsoleApp
{
    public class Application
    {
        ...
        public Application(TrainService trainService, PassengerService passengerService, JourneyService journeyService)
        {
        ...
        private void Start()
        {
            ...
            Console.WriteLine(trainId + " " + origin + " - > " + destination); Console.ReadKey();
            _journeyService.SetTrains(_trainService.GetTrains());
        ...
        private void ListTrainPassengers()
        {
            Console.WriteLine("Enter Train ID:");
            int trainId = int.Parse(Console.ReadLine() ?? "0");
            var passengers = _trainService.GetPassengersByTrain(trainId, _passengerService.GetAllPassengers());
